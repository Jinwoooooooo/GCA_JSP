...
<body>
	...
	<a href="/ch06/shop/product/register.jsp">상품 등록</a>
	...
	<form action="/ch06/shop/order/proc/register.jsp" method="post">
		<table border="1">
			<tr>
				<td>상품번호</td>
				<td>
					<input type="number" name="orderProduct" placeholder="상품번호 입력">
				</td>
			</tr>
			<tr>
				<td>주문자 아이디</td>
			...
			<tr>
				<td>주문수량</td>
				<td>
					<input type="text" name="orderCount" placeholder="주문수량 입력">
				</td>
			</tr>
			<tr>
